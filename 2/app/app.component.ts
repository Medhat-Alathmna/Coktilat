...
export class AppComponent implements OnInit {
  ...
  toggleCard(selected: any, currentIndex) {
    ...
    const nextItem = this.users[currentIndex + 1]
    if (this.isMultipleOfThree(currentIndex) && currentIndex != this.users?.length - 1) {
      this.users.splice(currentIndex + 1, 1);
      this.users.splice(currentIndex, 0, nextItem);
    }
